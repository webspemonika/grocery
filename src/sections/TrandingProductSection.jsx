...
const TrandingProductSection = () => {

    const products = [
        {
            id: 1,
            productName: "Red Cabbage 1 kg (Approx. 900 g - 1000 g)",
            defaultImage: "/images/beverage/cake-default.jpg",
            hoverImage: '/images/beverage/cake-hover.jpg',
            rating: "3.5",
            discount: "10%",
            stockStatus: "",
            currentPrice: "$55",
            ...
            defaultImage: "/images/beverage/cheese-default.jpg",
            hoverImage: '/images/beverage/cheese-hover.jpg',
            rating: "4",
            discount: "",
            stockStatus: "",
            currentPrice: "$2",
        ...
        },
        {
            ...
            defaultImage:"/images/beverage/didi-default.jpg",
            hoverImage: ' /images/beverage/didi-hover.jpg',
            rating: "",
            discount: "",
            stockStatus: "",
            currentPrice: "",
        ...
        },
        {
            ...
            defaultImage: "/images/beverage/haniz-default.jpg",
            hoverImage: '  /images/beverage/haniz-hover.jpg',
            rating: "5",
            discount: "20%",
            stockStatus: "",
            currentPrice: "$30",
...

        {
            ...
            defaultImage: "/images/beverage/jacobs-hover.jpg",
            hoverImage: '/images/beverage/jacobs.jpg',
            rating: "5",
            discount: "",
            stockStatus: "",
            currentPrice: "$45",
        ...
        },
        {
            ...
            defaultImage: "/images/beverage/milky.jpg",
            hoverImage: '/images/beverage/milky-hover.jpg',
            rating: "5",
            discount: "",
            stockStatus: "",
            currentPrice: "$5",
...

        {
            id: 7,
            productName: "Coconut Kalash 5 pcs (Pack) (Approx 1600 g - 2000 g)",
            defaultImage: "/images/beverage/menisi-default.jpg",
            hoverImage: '/images/beverage/menisi-hover.jpg',
            rating: "5",
            discount: "",
            stockStatus: "",
            currentPrice: "$5",
        ...
        },
        {
            id: 8,
            productName: "",
            defaultImage: "/images/beverage/mausmanaton-default.jpg",
            hoverImage: '/images/beverage/mausmanaton-hover.jpg',
            rating: "5",
            discount: "",
            stockStatus: "",
            currentPrice: "$5",
                    ...
                    <div className="py-0 lg:py-3.75 mb-2 lg:mb-2 flex flex-col lg:flex-row lg:items-center lg:gap-0 gap-5">
                        ...
                        <div className="flex justify-between md:justify-start gap-2 items-center">
                            <div className="flex gap-2.5  ">
                                <button className=" filter-btn "> features products </button>
                                <button className=" filter-btn "> new products </button>
                            </div>
